...
&emsp;&emsp;上次更新时间：2026 年 4 月 13 日 13:00 (GMT+8)

&emsp;&emsp;**截至 2026 年 4 月 13 日，本中心已打击计算机病毒 / 恶意软件 832 个、恶意网站 303 个，累计为潜在受害者规避经济损失约 5,705,856 元人民币**。[ $$E = \sum (W_i \times P_{\text{exec}} \times N_{\text{victim}} \times P_{\text{monetize}} \times V_{\text{loss}})$$ ] ([何意味？](https://github.com/Lingggao/LGSRC/blob/main/LossModel.md))
...
| 2026/4/13 |        tod.exe        | **银狐 (SilverFox.sa)**  | e0fa452c7672f34e7f92d0a6a43d51baadecbebc5b134fb1e83c80085a09f9bd |                                      | [VirusTotal](https://www.virustotal.com/gui/file/e0fa452c7672f34e7f92d0a6a43d51baadecbebc5b134fb1e83c80085a09f9bd) (24) | [MalwareBazaar Database](https://bazaar.abuse.ch/sample/e0fa452c7672f34e7f92d0a6a43d51baadecbebc5b134fb1e83c80085a09f9bd) | A832 |
|  ——————   |     ————————————      |       ————————————       |             ———————————————————————————————————              |         ————————————————————         |                           ————————                           |                         ————————————                         | ———  |
