...
> [!NOTE]
>
> &emsp;只保留最近 10 天内的最多 30 条数据，更早数据详见 LGSRC/[Archive.md](https://github.com/Lingggao/LGSRC/blob/main/Archive.md) (归档)。
...
> [!NOTE]
>
> &emsp;只保留最多 30 条数据，更早数据详见 LGSRC/[Archive.md](https://github.com/Lingggao/LGSRC/blob/main/Archive.md) (归档)。
